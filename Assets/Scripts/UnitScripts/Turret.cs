...
public class Turret : AttackableObject
{
    ...
    public override void Populate(int teamCode)
    {
        ...
        rangeMarker.transform.localScale = new Vector3(idealRange, idealRange, 1);
    }

    public override void SetSelected(bool selected, bool only)
    {
        base.SetSelected(selected, only);
